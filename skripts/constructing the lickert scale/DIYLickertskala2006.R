#by Julius Hehenkamp
### Rotiertes Balkendiagram für Likertskalen 2006 ###
...
database <- database[!(database$year!=2006),]
View(database)

### Erstelle datensatz für die Items mp03 bis mp08 ###

mpdata2 <- database[ ,228:233]
View(mpdata2)

### Formatiere Fehlwerte von -9 auf NA ###

mpdata2[mpdata2 == -9] <- NA

### Umpolung negativer Items ###

mpdata2$mp04 = 7 + 1 - mpdata2$mp04
mpdata2$mp06 = 7 + 1 - mpdata2$mp06
mpdata2$mp07 = 7 + 1 - mpdata2$mp07

# Cronbach-Alpha # 

sjt.itemanalysis(mpdata2) # Tabelle mit Grunddaten #

### Erstelle ersten Likertplot ###

x<- mpdata2[complete.cases(mpdata2),]
...
extra_items <- dplyr::select(mpdata2, 1:6)
